...
@onready var play: TextureButton = $MarginContainer/VBoxContainer/Play
@onready var options: TextureButton = $MarginContainer/VBoxContainer/Options
@onready var quit: TextureButton = $MarginContainer/VBoxContainer/Quit
